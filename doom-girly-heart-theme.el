...
(def-doom-theme doom-girly-heart
  ...
  ;; name        default   256       16
  ((bg-alt     '("#FFEBE6" "#FFEBE6" nil))
   (bg         '("#FDF0ED" "#FADAD1" nil))
   (fg         '("#E87DBE" "#E87DBE" nil))
   ...
   (fg-alt     '("#D5D8DA" "#D5D8DA" "brightblack"))
   (black      '("#333333" "#333333" "black"))

   (grey       (doom-lighten black 0.5))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (mode-line-highlight :background fg-alt :foreground fg)
   ...
   (doom-modeline-info :background fg-alt :foreground cyan)
   ...
   (markdown-table-face            :foreground fg :background (doom-lighten bg-alt 0.5))
   ((markdown-code-face &override) :foreground orange :background (doom-lighten bg-alt 0.5))

   ;; outline (affects org-mode)
   ((outline-1 &override) :foreground blue :background nil)

   ;; org-mode
   ((org-block &override) :background (doom-lighten bg-alt 0.5))
   ((org-block-begin-line &override) :background (doom-lighten bg-alt 0.5) :foreground comments)
   ((org-quote &override) :background (doom-lighten bg-alt 0.5))
   ...
   (popup-tip-face :inherit 'popup-face :foreground magenta :background bg-alt)
   ...
   ;; company
   (company-box-background    :background bg-alt :foreground fg)
   ...
   ;; pyim
   (pyim-page :background base8 :foreground magenta)
